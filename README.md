# AI 栄養＆レシピ提案アプリ
<img width="1536" height="524" alt="image" src="https://github.com/harut-11/Diet-support/blob/main/static/images/rezipi.png" />

## 📢 「食事管理なんて、自分には関係ないアスリートだけのもの」と思っていませんか？

実は、例えばプロ選手が「勝利」のために行う栄養管理も、私たちが「日々の元気、健康」のために行う食事も、**「身体を作り、最高のパフォーマンスを出す」という本質はまったく同じ**です。

* **アスリート:** 激しい運動に耐え、結果を出すためのエネルギー管理
* **私たち:** 病気を防ぎ、毎日を元気に過ごすための健康維持

- どちらも鍵となるのは、「何を」「何と組み合わせて」「どう食べるか」。
- しかし、毎食栄養バランスを完璧に考えるのは、忙しい私たちには至難の業です。
-bそこで、AIがあなたの「専属コンディション・コーチ」になります。
-「今のあなたに足りない栄養」を補う副菜や、「今日の元気レベル」に合わせたレシピ（5分でできる時短料理から、本格派の一品まで）をAIが即座に提案します。
- アレルギーや苦手な食材もしっかり考慮。 あなただけの専属コーチと一緒に、毎日の食事から「最高の自分・」を健康を維持しませんか？
